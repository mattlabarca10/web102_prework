...
function addGamesToPage(games) {
    for (let i = 0; i < games.length; i++) {
        ...
        gamesContainer.appendChild(gameCard); // Appending here
    }
}
...
const unfundedGamesDescription = `We currently have ${unfundedGamesCount} unfunded game${unfundedGamesCount === 1 ? '' : 's'}.`;

// create a new DOM element containing the template string and append it to the description container
const unfundedGamesExplanation = document.createElement("p");
unfundedGamesExplanation.textContent = unfundedGamesDescription;
descriptionContainer.appendChild(unfundedGamesExplanation);
...
firstGameNameElement.textContent = `Top Funded Game: ${firstGame.name}`;
firstGameContainer.appendChild(firstGameNameElement);

// do the same for the runner up item
const secondGameNameElement = document.createElement("p");
secondGameNameElement.textContent = `Top Funded Game: ${secondGame.name}`;
